...
public class MyCursorAdapter_eat extends SimpleCursorAdapter {
    ...
    public MyCursorAdapter_eat(Context context, int layout, Cursor c, String[] from, int[] to) {
    ...
    public View getView(int pos, View inView, ViewGroup parent) {
        ...
        if (struri != null) { textView.setText(struri); }

        TextView textView1 = (TextView) v.findViewById(to[1]);
        if (txt != null) { textView1.setText(txt); }
